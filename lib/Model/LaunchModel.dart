...
LaunchModel apiModelFromJson(String str) => LaunchModel.fromJson(json.decode(str));
String apiModelToJson(LaunchModel data) => json.encode(data.toJson());
...
class LaunchModel {
  ...
  factory LaunchModel.fromJson(Map<String, dynamic> json) => LaunchModel(
        ...
        staticFireDateUtc:
            json["static_fire_date_utc"] == null ? null : DateTime.parse(json["static_fire_date_utc"]),
...
class Flickr {
  ...
  factory Flickr.fromJson(Map<String, dynamic> json) => Flickr(
        ...
        original: json["original"] == null ? null : List<dynamic>.from(json["original"].map((x) => x)),
      );
